...
const LoginPage = () => {
  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center">
      <div className="h-1/3 w-1/3 rounded border-2 bg-cyan-50 block">
        ...
        <div className="flex-shrink flex items-center justify-center pt-5">
          <button onClick={createPost} className="bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-normal font-bold border-4 text-white py-1 px-2 rounded">
              Login
          </button>
        </div>
      </div>
